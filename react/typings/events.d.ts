export interface PixelMessage extends MessageEvent {
  data: ProductViewData | ProductClickData | OrderPlacedData | PageViewData | ProductImpressionData | AddToCartData | RemoveFromCartData | PageInfoData
}
...
export interface PageInfoData extends EventData {
  eventType: 'departmentView' | 'categoryView' | 'internalSiteSearchView' | 'homeView' | 'productView'
  pageCategory: 'Department' | 'Category' | 'InternalSiteSearch' | 'Home' | 'Product'
